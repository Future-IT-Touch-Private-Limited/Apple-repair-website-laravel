...
class PostTagController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.backend.posttag.index')->with('postTags',$postTag);
    }
    ...
    {
        return view('admin.backend.posttag.create');
    }
    ...
    public function edit($id)
    {
        ...
        return view('admin.backend.posttag.edit')->with('postTag',$postTag);
    }
