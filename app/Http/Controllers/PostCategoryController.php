...
class PostCategoryController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.backend.postcategory.index')->with('postCategories',$postCategory);
    }
    ...
    {
        return view('admin.backend.postcategory.create');
    }
    ...
    public function edit($id)
    {
        ...
        return view('admin.backend.postcategory.edit')->with('postCategory',$postCategory);
    }
