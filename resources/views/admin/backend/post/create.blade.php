    ...
    <div class="card-body">
      <form method="post" action="{{route('post.store')}}" enctype="multipart/form-data">
        ...
        <div class="mb-3">
          ...
          <input class="form-control" type="file" name="photo" id="formFileMultiple" value="{{old('photo')}}" multiple="">
        </div>
        ...
        <div id="holder" style="margin-top:15px;max-height:100px;"></div>
         ...
         <div class="row mb-3">
                                    <label for="inputEmail3" class="col-form-label">Meta keywords</label>
                                        ...
                                        <div >
                                          <input type="text" name="meta_keywords" class="form-control" id="inputText">
                                        </div>
                                  </div>
                                   <div class="row mb-3">
                                    <label for="inputEmail3" class="col-form-label">Meta description</label>
                                        ...
                                        <div >
                                          <input type="text" name="meta_description" class="form-control" id="inputText">
                                        </div>
                                  </div>
